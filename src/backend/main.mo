...
actor {
  ...
  var nextEmployeeId : Common.UserId;

  func initSampleData() {
    let sampleEmployees : [Types.Employee] = [
    ...
    let sampleMetrics : [Types.PerformanceMetrics] = [
  ...
  include MixinViews();
  include EmployeeApi({ var data = employees }, { var data = metrics }, { var nextEmployeeId });
};
